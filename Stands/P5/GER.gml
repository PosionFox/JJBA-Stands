...
_skills[sk, StandSkill.Desc] = "requiem:\nawaken your stand.";
...
_skillsGer[sk, StandSkill.Desc] = "requiem taunt";
...
_skillsGer[sk, StandSkill.Desc] = "null barrage:\nlaunches a destructive barrage of punches.";
...
_skillsGer[sk, StandSkill.Desc] = "life punch:\npunches the enemy and pulls their soul out,\nthe soul damages other enemies.";
...
_skillsGer[sk, StandSkill.Desc] = "self heal:\nmends the user's wounds,\nthe effectiveness of the healing is tied to the user's level.";
