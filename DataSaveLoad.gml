...
var _data = ModSaveDataFetch();

var _stand = _data[? "jjbamAbility"];
...
switch (_stand)
{
    ...
    case "jjbamD4c":
        GiveD4C(player);
        STAND.hasArm = _data[? "jjbamD4cHasArm"];
        STAND.hasHeart = _data[? "jjbamD4cHasHeart"];
        STAND.hasEye = _data[? "jjbamD4cHasEye"];
    break;
    ...
    case "jjbamTsk":
        GiveTusk(player);
        STAND.hasAct1 = _data[? "jjbamTuskA1"];
        STAND.hasAct2 = _data[? "jjbamTuskA2"];
        STAND.hasAct3 = _data[? "jjbamTuskA3"];
        STAND.hasAct4 = _data[? "jjbamTuskA4"];
    break;
    // other
